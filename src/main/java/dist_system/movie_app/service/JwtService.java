...
public class JwtService {
    ...
    public String generateToken(Map<String, Object> extraClaims, UserDetails userDetails) {
        return Jwts
                ...
                .signWith(getSigningKey(), SignatureAlgorithm.HS256) // HS256 is a symmetric algorithm
                .compact();
    ...
    //Key method is used to sign the JWT token and verify it during the parsing of the token
